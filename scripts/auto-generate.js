...
const SITE_NAME = 'サプリメントJP';
const TOPIC = 'サプリメント・栄養補助食品・ビタミン';
const CRITERIA = '成分・効果・飲みやすさ・コスパ・安全性';
const A8_NAME = 'ULTORAプロテイン';
const A8_URL = 'https://px.a8.net/svt/ejp?a8mat=4AZR8U+8CDSTM+4XHS+5YJRN';
const A8_DESC = '高品質プロテインで理想のボディへ';
