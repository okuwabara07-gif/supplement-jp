...
const TOPIC = 'サプリメント・栄養補助食品・健康食品';
const CRITERIA = '効果・成分・コスパ・安全性・口コミ';
...
async function generateArticle(keyword) {
  ...
  // A8.net高単価アフィリエイトリンク
  const a8_ultoraLink = `[→ ULTORAプロテインはこちら](https://px.a8.net/svt/ejp?a8mat=4AZR8U+GGEBOY+4NL2+601S1)`;
